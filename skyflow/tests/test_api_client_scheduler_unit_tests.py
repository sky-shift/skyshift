...
pytest skyflow/tests/api_client_scheduler_unit_tests.py

To run one specific test, use the following command:
pytest skyflow/tests/api_client_scheduler_unit_tests.py::test_namespace_object_api_create_success
