...
def copy_required_files(ssh_client: paramiko.SSHClient, remote_dir: str, logger: logging.Logger):
...
def find_available_container_managers(ssh_client: paramiko.SSHClient, logger: logging.Logger) -> list:
