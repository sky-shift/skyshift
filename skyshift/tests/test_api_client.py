...
pytest skyshift/tests/api_client_unit_tests.py

To run one specific test, use the following command:
pytest skyshift/tests/api_client_unit_tests.py::test_namespace_object_api_create_success
...
def test_namespace_object_api_watch(namespace_api: NamespaceObjectAPI,
    ...
    monkeypatch.setattr("skyshift.api_client.object_api.watch_events",
                        mock_watch_events)
